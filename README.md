...
ML/AI Engineer · Burmese grad in Thailand

<p style="font-size: 1rem; font-weight: 400; margin-top: 1rem;">
...
- **LLM Fine-tuning for ATE & ASC** – Finetuned Llama 3 8b and Mistral 7b model with improved F1 & accuracy for extacting important aspect words from domain specific reviews and analyzing sentiment on each words.  
